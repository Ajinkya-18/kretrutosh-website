...
const Book = () => {
  ...
  const renderSection = (sectionKey: string) => {
    switch (sectionKey) {
      case 'hero':
        if (!bookData.hero_title) return null;
        return (
          <section key="hero" className="py-24 pt-48 text-center bg-gradient-to-br from-primary/5 via-background to-accent/5">
      ...
      case 'content':
        return (
          <section key="content" className="py-20">
            <div className="container mx-auto px-4">
      ...
      case 'author':
        if (!bookData.author_bio) return null;
        return (
          <section key="author" className="py-20">
            <div className="container mx-auto px-4">
              <div className="max-w-6xl mx-auto">
  ...
  // Get layout order and section visibility from bookData
  const layoutOrder = bookData?.layout_order || ["hero", "content", "author"];
  const sectionVisibility = bookData?.section_visibility || {
    hero: true,
    content: true,
    author: true
  };
