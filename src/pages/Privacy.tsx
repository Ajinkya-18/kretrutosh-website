          ...
          <div className="prose prose-lg dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2">
                ...
                <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Kretrutosh consulting, Mumbai, Maharashtra, India.</li>
                ...
                <li><strong>Website</strong> refers to KRETRUTOSH CONSULTING, accessible from Www.kretru.com</li>
                <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-primary mb-4">Collecting and Using Your Personal Data</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-primary mb-4">Use of Your Personal Data</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-primary mb-4">Retention of Your Personal Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-primary mb-4">Transfer of Your Personal Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-primary mb-4">Delete Your Personal Data</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-primary mb-4">Disclosure of Your Personal Data</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-primary mb-4">Security of Your Personal Data</h2>
              <p>
